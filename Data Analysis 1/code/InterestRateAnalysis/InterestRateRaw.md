...
AmountRequestCut = cut(loans$Amount.Requested, cuts)
AmountFundedByInvestorCut = cut(loans$Amount.Funded.By.Investors, cuts)
lmIRFRARAFI <- lm(loans$Interest.Rate ~ loans$FICO.Range.L + AmountRequestCut + 
...
## 
## Call:
## lm(formula = loans$Interest.Rate ~ loans$FICO.Range.L + AmountRequestCut + 
##     AmountFundedByInvestorCut)
## 
## Residuals:
##    Min     1Q Median     3Q    Max 
## -7.951 -1.682 -0.244  1.559 10.073 
## 
## Coefficients:
##                                             Estimate Std. Error t value
## (Intercept)                                 73.69077    0.99229   74.26
## loans$FICO.Range.L                          -0.08807    0.00141  -62.66
## AmountRequestCut(7.78e+03,1.46e+04]          0.03498    0.21988    0.16
## AmountRequestCut(1.46e+04,2.14e+04]          1.57374    0.31842    4.94
## AmountRequestCut(2.14e+04,2.82e+04]          2.87164    0.52462    5.47
## AmountRequestCut(2.82e+04,3.5e+04]           3.55073    0.90247    3.93
## AmountFundedByInvestorCut(6.98e+03,1.4e+04]  0.84080    0.21955    3.83
## AmountFundedByInvestorCut(1.4e+04,2.1e+04]   1.27308    0.31914    3.99
## AmountFundedByInvestorCut(2.1e+04,2.8e+04]   1.37899    0.54613    2.53
## AmountFundedByInvestorCut(2.8e+04,3.5e+04]   2.47441    0.92059    2.69
##                                             Pr(>|t|)    
## (Intercept)                                  < 2e-16 ***
## loans$FICO.Range.L                           < 2e-16 ***
## AmountRequestCut(7.78e+03,1.46e+04]          0.87363    
## AmountRequestCut(1.46e+04,2.14e+04]          8.2e-07 ***
## AmountRequestCut(2.14e+04,2.82e+04]          4.8e-08 ***
## AmountRequestCut(2.82e+04,3.5e+04]           8.6e-05 ***
## AmountFundedByInvestorCut(6.98e+03,1.4e+04]  0.00013 ***
## AmountFundedByInvestorCut(1.4e+04,2.1e+04]   6.8e-05 ***
## AmountFundedByInvestorCut(2.1e+04,2.8e+04]   0.01163 *  
## AmountFundedByInvestorCut(2.8e+04,3.5e+04]   0.00724 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 
## 
## Residual standard error: 2.45 on 2490 degrees of freedom
## Multiple R-squared: 0.658,	Adjusted R-squared: 0.657 
## F-statistic:  532 on 9 and 2490 DF,  p-value: <2e-16
```
...
```
##                                                2.5 %   97.5 %
## (Intercept)                                 71.74497 75.63657
## loans$FICO.Range.L                          -0.09083 -0.08532
## AmountRequestCut(7.78e+03,1.46e+04]         -0.39620  0.46615
## AmountRequestCut(1.46e+04,2.14e+04]          0.94934  2.19814
## AmountRequestCut(2.14e+04,2.82e+04]          1.84290  3.90038
## AmountRequestCut(2.82e+04,3.5e+04]           1.78106  5.32040
## AmountFundedByInvestorCut(6.98e+03,1.4e+04]  0.41028  1.27132
## AmountFundedByInvestorCut(1.4e+04,2.1e+04]   0.64727  1.89888
## AmountFundedByInvestorCut(2.1e+04,2.8e+04]   0.30808  2.44989
## AmountFundedByInvestorCut(2.8e+04,3.5e+04]   0.66921  4.27960
```
